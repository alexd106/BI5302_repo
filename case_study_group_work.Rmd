...
```{r, nereis, echo=FALSE, fig.align='center', out.width='60%', fig.cap = "https://en.wikipedia.org/wiki/Hediste_diversicolor"}
...
```{r, stilt, echo=FALSE, fig.align='center', out.width='50%', fig.cap = "https://en.wikipedia.org/wiki/Hawaiian_stilt"}
